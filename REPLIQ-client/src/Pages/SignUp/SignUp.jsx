            ...
            <div className="flex flex-col items-center justify-center">
                <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10">
                    ...
                    <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                        ...
                        <Link to={'/login'}><span tabIndex={0} className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                            {" "}
                            Login here
                        </span></Link>
                    </p>
                    <div onClick={handleGoogleSignIn} className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10 cursor-pointer">
                    ...
                    <div className="mt-6 w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            <div className="absolute right-0 mt-2 mr-3 cursor-pointer">
                                <div className="h-5 w-5" onClick={toggleShowPassword}>
                                    {showPassword ? <AiOutlineEyeInvisible className="h-full w-full" /> : <AiOutlineEye className="h-full w-full" />}
                                </div>
                            </div>
                        </div>
