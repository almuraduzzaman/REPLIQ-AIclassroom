        ...
        <div className="bg-gradient-to-r from-gray-100 via-[#4c76a152] to-gray-100 px-4 pt-16 md:px-24">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <p className="flex items-center gap-2 text-gray-800"><FaPhoneAlt /> +8801521543097</p>
                    <p className="flex items-center gap-2 text-gray-800"><MdEmail /> almuraduz@gmail.com</p>
                    <p className="flex items-center gap-2 text-gray-800"><FaLocationArrow /> Bogura Sadar, Bogura - 5800</p>
                </div>
                <div>
